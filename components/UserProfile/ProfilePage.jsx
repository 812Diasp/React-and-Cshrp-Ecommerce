...
<form>
                        <div className="account-info-fields">
                            <div className="account-field">
                                <p>First Name</p>
                                <input className="account-edit-field password-field navbar-search" type="text" placeholder="Denis"/>
                            </div>
                            <div className="account-field">
                                <p>Last Name</p>
                                <input className="account-edit-field password-field navbar-search" type="text" placeholder="Tkachenko"/>
                            </div>
                            <div className="account-field">
                                <p>Email</p>
                                <input className="account-edit-field password-field navbar-search" type="text" placeholder="asoffoto1@gmail.com"/>
                            </div>
                            <div className="account-field">
                                <p>Address</p>
                                <input className="account-edit-field password-field navbar-search" type="text" placeholder="Stavropol"/>
                            </div>
                        </div>
    ...
    <button className={' mt-3 btn btn-danger btn-confirm-changes'} type={'submit'}>Confirm Changes</button>
</form>
                    </div>
                </div>
            </div>
