...
const FlashSale = ({HasCountdown,Text, DisplayTitle,Title,hasSlider,ViewAll}) => {
    let saleProducts = [
        {
    ...
    const targetDate = '2025-1-1 00:00:00';
    return (
        <div className={'flash-sale'}>
            ...
            {hasSlider? <SaleSlider saleProducts={saleProducts}></SaleSlider>:""}
